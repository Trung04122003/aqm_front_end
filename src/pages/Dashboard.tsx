...
export default function ChristmasDashboard() {
  ...
  const getAQIStatus = (aqi: number) => {
    ...
    if (aqi <= 200) return { label: "Unhealthy - High Alert", color: "#FF6347", emoji: "⚠️", bg: "rgba(255, 99, 71, 0.1)" };
    if (aqi <= 300) return { label: "Very Unhealthy", color: "#C41E3A", emoji: "😷", bg: "rgba(196, 30, 58, 0.1)" };
    return { label: "Hazardous - Blizzard Warning", color: "#8B0000", emoji: "☠️", bg: "rgba(139, 0, 0, 0.1)" };
  };

  const calculateDistribution = () => {
    if (!history || history.length === 0) return { good: 0, moderate: 0, unhealthy: 0, veryUnhealthy: 0 };
  ...
  const doughnutData = {
    ...
    datasets: [
      {
        data: [distribution.good, distribution.moderate, distribution.unhealthy, distribution.veryUnhealthy],
  ...
  return (
    <MainLayout>
      ...
      <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #E0F7FA 0%, #B3E5FC 50%, #FFFAFA 100%)", padding: "2rem", position: "relative", overflow: "hidden" }}>
          ...
          <div className="col-12 col-lg-4">
            ...
            >
              ...
              <div className="card-body p-5 text-center position-relative">
                ...
                <div className="h5 mb-3" style={{ color: status.color, fontWeight: "bold" }}>
                  {status.label}
                </div>
                ...
                <div className="d-flex justify-content-center align-items-center gap-2 mb-4">
                  {trend === 'up' && (
                    <>
                      ...
                      <span className="small" style={{ color: "#FF6347" }}>Increasing</span>
                    </>
                  )}
                  {trend === 'down' && (
                    <>
                      <FaArrowDown style={{ color: "#10b981" }} />
                      <span className="small" style={{ color: "#10b981" }}>Decreasing</span>
                    </>
                  )}
                  {trend === 'stable' && (
                    <>
                      <FaMinus style={{ color: "#FFD700" }} />
                      <span className="small" style={{ color: "#FFD700" }}>Stable</span>
                    </>
                  )}
                </div>
            ...
            >
              <div className="card-body p-4">
                ...
                <div className="row g-3">
                  ...
                  <div className="col-6">
                    <div className="d-flex align-items-center gap-2 p-3 rounded-3" style={{ background: "rgba(255, 215, 0, 0.1)", border: "2px solid #FFD700" }}>
                      <FaCompress style={{ fontSize: "24px", color: "#FFD700" }} />
                      <div>
                  ...
                  <div className="col-6">
                    <div className="d-flex align-items-center gap-2 p-3 rounded-3" style={{ background: "rgba(103, 232, 249, 0.1)", border: "2px solid #FFD700" }}>
                      <FaCloudRain style={{ fontSize: "24px", color: "#67e8f9" }} />
                      <div>
        ...
        <div className="row g-4 mb-4">
          {[
            { label: "NO₂", value: currentData?.no2, icon: <FaSmog />, color: "#ff6b6b", unit: "mg/m³" },
            { label: "SO₂", value: currentData?.so2, icon: <FaFire />, color: "#fbbf24", unit: "mg/m³" },
            { label: "CO", value: currentData?.co, icon: <FaLeaf />, color: "#10b981", unit: "mg/m³" },
            { label: "O₃", value: currentData?.o3, icon: <FaWind />, color: "#67e8f9", unit: "mg/m³" },
          ].map((pollutant, idx) => (
            <div key={idx} className="col-6 col-md-3">
              ...
              >
                <div className="card-body p-4 text-center">
                  <div style={{ fontSize: "2rem", color: pollutant.color, marginBottom: "0.5rem" }}>
                    {pollutant.icon}
                  </div>
                  <div className="small text-muted mb-2">{pollutant.label}</div>
                  <div className="h4 fw-bold mb-0" style={{ color: pollutant.color }}>
              ...
              <div className="card-body p-4">
                <div className="d-flex align-items-center justify-content-between mb-4">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <h5 className="mb-0" style={{ color: "#165B33", fontWeight: "bold" }}>📊 24-Hour AQI Trend</h5>
                  </div>
                  <motion.div
                    ...
                    options={{
                      ...
                      scales: {
                        y: { 
                          ...
                          title: { display: true, text: "AQI Value", color: "#165B33", font: { size: 14, weight: "bold" } }
                        },
                        x: { 
                          grid: { display: false },
                          ticks: { color: "#165B33", font: { weight: "bold" }, maxRotation: 45, minRotation: 45 },
                          title: { display: true, text: "Time", color: "#165B33", font: { size: 14, weight: "bold" } }
                        },
                      },
                    }}
                  />
        ...
        >
          <div className="card-body p-4">
            <div className="d-flex align-items-center gap-2 mb-4">
              ...
              <h5 className="mb-0" style={{ color: "#165B33", fontWeight: "bold" }}>🎁 PM2.5 vs PM10 (Last 6 Hours)</h5>
            </div>
                ...
                options={{
                  ...
                  scales: {
                    y: {
                      ...
                      grid: { color: "rgba(196, 30, 58, 0.1)" },
                      ticks: { color: "#165B33", font: { weight: "bold" } },
                      title: { display: true, text: "µg/m³", color: "#165B33", font: { size: 14, weight: "bold" } }
                    },
                    x: {
                      grid: { display: false },
                      ticks: { color: "#165B33", font: { weight: "bold" } }
        ...
        >
          <div className="card-body p-5">
            <div className="d-flex align-items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="mb-1" style={{ color: "#C41E3A", fontWeight: "bold" }}>
            ...
            <div className="row g-4">
              {aqi <= 50 && (
                <div className="col-12">
                  <div className="d-flex align-items-start gap-3 p-4 rounded-3" style={{ background: "rgba(22, 91, 51, 0.1)" }}>
                    <FaCheckCircle size={32} style={{ color: "#10b981", flexShrink: 0 }} />
                    <div>
                      <h6 className="fw-bold mb-2" style={{ color: "#165B33" }}>Excellent Air Quality! 🎉</h6>
                      <p className="mb-2">Perfect conditions for outdoor activities. Santa approves!</p>
                      <ul className="mb-0">
              ...
              {aqi > 50 && aqi <= 100 && (
                <div className="col-12">
                  <div className="d-flex align-items-start gap-3 p-4 rounded-3" style={{ background: "rgba(255, 215, 0, 0.1)" }}>
                    <FaExclamationCircle size={32} style={{ color: "#FFD700", flexShrink: 0 }} />
                    <div>
                      <h6 className="fw-bold mb-2" style={{ color: "#B8860B" }}>Moderate Air Quality</h6>
                      <p className="mb-2">Acceptable for most people, but sensitive groups should take precautions.</p>
                      <ul className="mb-0">
                        <li>Unusually sensitive people may experience symptoms</li>
              ...
              {aqi > 100 && (
                <div className="col-12">
                  <div className="d-flex align-items-start gap-3 p-4 rounded-3" style={{ background: "rgba(196, 30, 58, 0.1)" }}>
                    <FaExclamationCircle size={32} style={{ color: "#C41E3A", flexShrink: 0 }} />
                    <div>
                      <h6 className="fw-bold mb-2" style={{ color: "#C41E3A" }}>Unhealthy Air Quality! ⚠️</h6>
                      <p className="mb-2">Everyone may begin to experience health effects. Take precautions!</p>
                      <ul className="mb-0">
        ...
        >
          ...
          <p className="text-muted small">
            Data updates every 5 minutes • Last update: {lastUpdate?.toLocaleString("vi-VN") || "Never"}
          </p>
        </motion.div>
      </div>
    </MainLayout>
